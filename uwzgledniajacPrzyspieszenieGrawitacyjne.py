...
suwakPredkoscWylotu = Slider(ax_predkosc, 'Prędkość wylotu spalanego paliwa [m/s]', 1000, 4000, valinit=predkoscWylotu, color="maroon")
suwakProcentPaliwa = Slider(ax_paliwo, '% paliwa w masie rakiety ', 80, 99, valinit=procentPaliwa, color="maroon")
